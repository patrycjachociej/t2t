...
$('.l1').click(function() {
	...
	$('.l1').addClass('active');
	$('.i2, .n2, .h2, .p2, .i3, .n3, .h3, .p3, .i4, .n4, .h4, .p4, .i5, .n5, .h5, .p5, .a-way2, .a-way3, .a-way4, .a-way5').fadeOut(100);
	$('#slider a').show();
...
$('.l2').click(function() {
	...
	$('.leave').removeClass('active');
	$('.l2').addClass('active');
	$('.i1, .n1, .h1, .p1, .i3, .n3, .h3, .p3, .i4, .n4, .h4, .p4, .i5, .n5, .h5, .p5, .a-way1, .a-way3, .a-way4, .a-way5').fadeOut(100);
	$('#slider a').show();
...
$('.l3').click(function() {
	...
	$('.leave').removeClass('active');
	$('.l3').addClass('active');
	$('.i1, .n1, .h1, .p1, .i2, .n2, .h2, .p2, .i4, .n4, .h4, .p4, .i5, .n5, .h5, .p5, .a-way1, .a-way2, .a-way4, .a-way5').fadeOut(100);
	$('#slider a').show();
...
$('.l4').click(function() {
	...
	$('.leave').removeClass('active');
	$('.l4').addClass('active');
	$('.i1, .n1, .h1, .p1, .i2, .n2, .h2, .p2, .i3, .n3, .h3, .p3, .i5, .n5, .h5, .p5, .a-way1, .a-way2, .a-way3, .a-way5').fadeOut(100);
	$('#slider a').show();
...
$('.l5').click(function() {
	...
	$('.leave').removeClass('active');
	$('.l5').addClass('active');
	$('.i1, .n1, .h1, .p1, .i2, .n2, .h2, .p2, .i3, .n3, .h3, .p3, .i4, .n4, .h4, .p4, .a-way1, .a-way2, .a-way3, .a-way4').fadeOut(100);
	$('#slider a').show();
...
function init() {
    var mapOptions = {
        ...
        zoom: 11,
        center: new google.maps.LatLng(-34.8749887, 138.3902261),
        styles: [
    {
